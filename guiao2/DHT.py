...
if __name__ == "__main__":
    ...
    logfile = {}
    if args.savelog:    # Se eu quiser guardar os dados da conexão, preciso de inserir a opção "--savelog" (os dados serão guardados no file 'dht.txt')
    ...
    # args.nodes = nº de nós que passo como argumento ao correr o programa